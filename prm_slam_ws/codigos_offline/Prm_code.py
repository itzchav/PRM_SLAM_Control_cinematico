...
def pixeles_a_metros(pixel_x, pixel_y):
    ...
    resx=(666-98)/28.6693
    resy=(735-175)/28.4363
    print(resy,resx)
    centro_y = 277  
    centro_x = 508
    metros_y = ((centro_y-pixel_y) / resy)
    metros_x = ((centro_x-pixel_x) / resx)
    print("Coordenadas en metros del punto morado:", metros_x, metros_y)
...
def prm( imagen, numero_de_muestras, distancia_max):
    ...
    punto_inicio = (508,277)
    punto_destino = (240, 300)
    ...
    while path is None:
        ...
        cv2.imwrite("grafo5.jpg", im)  # Guarda la imagen con la ruta y los puntos aleatorios dibujados.
        ...
        if nx.has_path(grafo, tuple(punto_inicio), tuple(punto_destino)):
            ...
            cv2.imwrite("prueba3_2000_1000.jpg", imagen_con_ruta)  # Guarda la imagen con la ruta y los puntos aleatorios dibujados.

            # Guardar los puntos aleatorios en un archivo CSV
            with open("puntos3_2000_1000.csv", "w", newline="") as csvfile:
            ...
            with open("prueba3_2000_1000.csv", "w", newline="") as csvfile2:
