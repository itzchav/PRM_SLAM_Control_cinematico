...
if("TRUE" STREQUAL "TRUE")
  set(prm_slam_SOURCE_PREFIX /home/karla/prm_slam_ws/src/prm_slam)
  set(prm_slam_DEVEL_PREFIX /home/karla/prm_slam_ws/devel)
  set(prm_slam_INSTALL_PREFIX "")
  set(prm_slam_PREFIX ${prm_slam_DEVEL_PREFIX})
else()
  set(prm_slam_SOURCE_PREFIX "")
  set(prm_slam_DEVEL_PREFIX "")
  set(prm_slam_INSTALL_PREFIX /home/karla/prm_slam_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'prm_slam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/karla/prm_slam_ws/src/prm_slam/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/karla/prm_slam_ws/devel/lib;/home/karla/prm_slam_ws/devel/lib;/opt/ros/noetic/lib)
